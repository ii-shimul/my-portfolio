...
const About = () => {
  return (
    ...
    >
      <h2 className="text-3xl md:text-4xl text-center font-bold text-gray-800 dark:text-white md:mb-8 mb-4">
        About Me
      </h2>
      <div className="max-w-7xl mx-auto flex max-md:flex-col items-center justify-center md:gap-7">
        <motion.div
        ...
        >
          <h3 className="text-xl md:text-2xl font-bold text-gray-800 dark:text-white mb-3 md:mb-6 text-center">
            Me in my own words
          </h3>
          ...
          <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 mt-4 mb-6 leading-relaxed">
        ...
        <div className="divider md:divider-horizontal max-md:mt-9"></div>
        <Education></Education>
      </div>
    </div>
  );
